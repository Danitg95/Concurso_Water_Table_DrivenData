...
# Changes: To include the maximum number of categorical variables.
#------------------
...
#---- New 2021_09_03 -------
# Elegir hasta scheme_name (included) ...
minivel <- 3000 
var_god <- levels_val %>%
...
var_impor %>%
  ...
  theme_bw()
ggsave(
  paste("./charts/03_Importancia_algoritmo_ranger_variables_acierto_", 
        round(acierto_val,4),
...
fwrite(
  mysub, 
  paste("./submissions/03_ranger_acierto_", 
        round(acierto_val,4),
        "_numvars_",  nrow(var_impor), 
        "_.csv", sep =  "")
)
